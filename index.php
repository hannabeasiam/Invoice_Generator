    ...
    <table>
      ...
      <?php
        foreach ($result as $invoices) {
          ...
          echo '<td>' . '<a href="invoiceEdit.php?invoice_id=' . $invoices['invoice_id'] . '">Edit</a> | <a href="invoiceDelete.php?invoice_id=' . $invoices['invoice_id'] . '">Delete</a>| <a href="invoice.php?invoice_id=' . $invoices['invoice_id'] . '">Incoive Detail</a></td>';
          echo '</tr>';
        }
      ?>
      </tbody>
